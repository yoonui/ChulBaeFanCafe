...
<body>
	...
	<div class="special-menu">
		<div class="box-special-menu">
			<ul class="special-menus">
				...
				<li class="dot"><a href="/profile" title="철배프로필">철배님 프로필</a></li>
				<li class="dot"><a href="/bbs3" title="철배말">철배님 말씀</a></li>
				<li class="dot"><a href="/bbs4" title="철배뉴짤">철배님 뉴짤</a></li>
				<li><a href="/bbs5" title="자유게시판">자유게시판</a></li>
			</ul>
		</div>
	</div>
    ...
    <div class="main">
        ...
        <div class="cafe-menus">
            ...
            <ul>
                <li><img src="img/post.png" width="12" height="12"><a href="/profile">철배님 프로필</a></li>
                <li><img src="img/post.png" width="12" height="12"><a href="/bbs3">철배님 말씀</a></li>
                <li><img src="img/post.png" width="12" height="12"><a href="/bbs4">철배님 뉴짤</a></li>
            </ul>
            <div class="cafe-menus-title">
                <h3>팬 잔치</h3>
            </div>
            <ul>
                <li><img src="img/post.png" width="12" height="12"><a href="/bbs5">자유 게시판</a></li>
            </ul>
        </div>
        ...
        <div class="main-area">
        	<div>
                ...
                <a href="/update?bbsid=<%=bbsid%>" class="list-btn"><span>수정</span></a>
                <a onclick="return confirm('삭제하시겠습니까?')" href="/deleteAction?bbsid=<%=bbsid%>" class="list-btn"><span>삭제</span></a>
                <% } %>
                <a href="/<%=str%>" class="list-btn"><span>목록</span></a>
            </div>
        	<div class="post">
