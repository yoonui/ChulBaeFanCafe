...
<body> <!-- 철배님 뉴짤 -->
    ...
    <div class="main">
        ...
        <div class="main-area">
            <div class="cafe-post-all"><h3>철배님 뉴짤</h3></div>
            <div class="cafe-post">
           		<ul>
                    <li>제목</li>
                    <li>작성자</li>
                ...
                <%
                	...
                	ArrayList<BOARD> list = boarddao.getList(pageNumber, "철배님 뉴짤");
                	for(int i = 0; i<list.size(); i++){
                %>
                <ul class="cafe-post-middle">
                    <li><div class="cafe-post-dot"></div><a href="/view?location=bbs5&&bbsid=<%=list.get(i).getBbsid()%>"><%=list.get(i).getBbsTitle()%></a></li>
            ...
            <%} %>
             <%if(pageNumber!=1) {%>
	            <div class="cafe-arrow">
	                <a href="/bbs5?pageNumber=<%=pageNumber-1%>"><span>이전</span></a>
	            </div>
            <%} if(boarddao.nextPage(pageNumber+1, "철배님 뉴짤")) {%>
	            <div class="cafe-arrow">
	                <a href="/bbs5?pageNumber=<%=pageNumber+1%>"><span>다음</span></a>
	            </div>
            <%} %>
