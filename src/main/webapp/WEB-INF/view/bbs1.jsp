        ...
        <div class="main-area">
            ...
            <div class="cafe-post">
                ...
                <ul class="cafe-post-middle">
                    <li><div class="cafe-post-dot"></div><a href="/view?location=bbs1&&bbsid=<%=list.get(i).getBbsid()%>"><%=list.get(i).getBbsTitle()%></a></li>
            ...
            <%} %>
             <%if(pageNumber!=1) {%>
	            <div class="cafe-arrow">
	                <a href="/bbs1?pageNumber=<%=pageNumber-1%>"><span>이전</span></a>
	            </div>
            <%} if(boarddao.AllnextPage(pageNumber+1)) {%>
	            <div class="cafe-arrow">
	                <a href="/bbs1?pageNumber=<%=pageNumber+1%>"><span>다음</span></a>
	            </div>
            <%} %>
