...
<body> <!-- 전체글보기 -->
    ...
    <div class="main">
        ...
        <div class="main-area">
            <div class="cafe-post-all"><h3>전체글보기</h3></div>
            <div class="cafe-post">
           		<ul>
                    <li>제목</li>
                    <li>작성자</li>
                ...
                <%
                	...
                	ArrayList<BOARD> list = boarddao.getallList(pageNumber);
                	for(int i = 0; i<list.size(); i++){
                %>
                <ul class="cafe-post-middle">
                    <li><div class="cafe-post-dot"></div><a href="/ChulBae/view?location=bbs1&&bbsid=<%=list.get(i).getBbsid()%>"><%=list.get(i).getBbsTitle()%></a></li>
            ...
            <%} %>
             <%if(pageNumber!=1) {%>
	            <div class="cafe-arrow">
	                <a href="/ChulBae/bbs1?pageNumber=<%=pageNumber-1%>"><span>이전</span></a>
	            </div>
            <%} if(boarddao.AllnextPage(pageNumber+1)) {%>
	            <div class="cafe-arrow">
	                <a href="/ChulBae/bbs1?pageNumber=<%=pageNumber+1%>"><span>다음</span></a>
	            </div>
            <%} %>
